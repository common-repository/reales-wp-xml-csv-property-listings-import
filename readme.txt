...
* bug fix: can't match amenities with Cyrillic names
* bug fix: can't change "Search through the Media Library for existing images" option
* improvement: update rapid add-on api

= 1.1.2 =
* Added City field when a custom list is being used.
* Added filter 'wpai_reales_city_position' to control new city position.
...
= 1.0.8 =
* Compatibility update for latest version of RealesWP
* Fix PHP warning for empty amenities
